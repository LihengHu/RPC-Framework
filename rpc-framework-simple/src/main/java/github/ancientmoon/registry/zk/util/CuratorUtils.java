package github.ancientmoon.registry.zk.util;

import github.ancientmoon.enums.RpcConfigEnum;
import github.ancientmoon.utils.PropertiesFileUtil;
...
public final class CuratorUtils {
    ...
    private static void registerWatcher(String rpcServiceName, CuratorFramework zkClient) throws Exception {
        ...
        PathChildrenCacheListener pathChildrenCacheListener = (curatorFramework, pathChildrenCacheEvent) -> {
            ...
            if((serviceAddresses == null || serviceAddresses.size() == 0) && SERVICE_ADDRESS_MAP.containsKey(rpcServiceName)){
